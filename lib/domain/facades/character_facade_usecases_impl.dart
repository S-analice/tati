...
final class CharacterFacadeUseCasesImpl implements ICharacterFacadeUseCases {
  ...
  final IUpdateCharacterUseCase _updateCharacterUseCase; //adicionamos//
  ...
  CharacterFacadeUseCasesImpl({
    ...
    required IUpdateCharacterUseCase updateCharacterUseCase, //adicionamos//
       ...
       _updateCharacterUseCase = updateCharacterUseCase; //adicionamos//
